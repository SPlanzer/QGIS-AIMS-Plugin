...
<qgis version="2.18.3" simplifyAlgorithm="0" minimumScale="0" maximumScale="10000" simplifyDrawingHints="1" minLabelScale="1" maxLabelScale="10000" simplifyDrawingTol="1" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="1" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  ...
  <renderer-v2 forceraster="0" symbollevels="0" type="RuleRenderer" enableorderby="0">
    <rules key="{1d6a7a08-9486-40f6-8417-401fec194dc6}">
      <rule filter=" &quot;id&quot; is not null" key="{fb3bc738-2369-4e96-8073-7c3516069ba5}" symbol="0" label="Appellation"/>
    </rules>
    <symbols>
  ...
  <customproperties>
    ...
    <property key="labeling/fieldName" value="getParApp('Parcels (Labels)' )&#xa;&#xa;"/>
  ...
  <aliases>
    ...
    <alias field="ldt_loc_id" index="1" name=""/>
    <alias field="img_id" index="2" name=""/>
    <alias field="fen_id" index="3" name=""/>
    <alias field="toc_code" index="4" name=""/>
    <alias field="alt_id" index="5" name=""/>
    <alias field="area" index="6" name=""/>
    <alias field="nonsurvey_def" index="7" name=""/>
    <alias field="appellation_date" index="8" name=""/>
    <alias field="parcel_intent" index="9" name=""/>
    <alias field="status" index="10" name=""/>
    <alias field="total_area" index="11" name=""/>
    <alias field="calculated_area" index="12" name=""/>
    <alias field="audit_id" index="13" name=""/>
    <alias field="se_row_id" index="14" name=""/>
  </aliases>
  ...
  <attributetableconfig actionWidgetStyle="dropDown" sortExpression="" sortOrder="0">
    <columns>
      ...
      <column width="-1" hidden="0" type="field" name="ldt_loc_id"/>
      <column width="-1" hidden="0" type="field" name="img_id"/>
      <column width="-1" hidden="0" type="field" name="fen_id"/>
      <column width="-1" hidden="0" type="field" name="toc_code"/>
      <column width="-1" hidden="0" type="field" name="alt_id"/>
      <column width="-1" hidden="0" type="field" name="area"/>
      <column width="-1" hidden="0" type="field" name="nonsurvey_def"/>
      <column width="-1" hidden="0" type="field" name="appellation_date"/>
      <column width="-1" hidden="0" type="field" name="parcel_intent"/>
      <column width="-1" hidden="0" type="field" name="status"/>
      <column width="-1" hidden="0" type="field" name="total_area"/>
      <column width="-1" hidden="0" type="field" name="calculated_area"/>
      <column width="-1" hidden="0" type="field" name="audit_id"/>
      <column width="-1" hidden="0" type="field" name="se_row_id"/>
